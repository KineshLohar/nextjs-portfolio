...
export const HeroSection3 = () => {
    return (
        <div className="relative overflow-hidden w-full min-h-dvh flex flex-col text-center items-center justify-center">
            ...
            <div className="z-10 drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] px-4 flex flex-col text-center items-center justify-center">
                ...
                <AnimatedText
                    as="h1"
                    className="text-3xl sm:text-4xl md:text-6xl font-extrabold font-eaglelake text-zinc-200"
                    animation="rise"
                    initial="hidden"
                    animate="visible"
                ...
                {/* <AnimatedText
                    as="div"
                    className="mt-2 sm:text-xl font-serif text-zinc-300 font-medium tracking-widest"
                    animation="fade"
                >
                    Passionate <span className="px-2 py-0">Full Stack Developer</span>
                </AnimatedText> */}
                <TypewriterEffect />

...
export const ProjectCard = ({ project }: { project: ProjectType }) => {
    return (
        <div className="relative space-y-4 p-4 sm:p-6 py-6 border border-neutral-900 flex flex-col items-stretch bg-neutral-950 border- border-neutral-800/90- overflow-hidden transition-all duration-100 ">
            ...
            <p className="fade-up text-xs sm:text-sm text-zinc-200 capitalize">
                {project?.description}
            </p>


            <div className="fade-up flex items-center gap-3 flex-wrap mb-6">
                {
                ...
                <div className="flex items-center gap-4 mt-auto ml-auto text-white ">
                    {
                        ...
                        <Button
                            asChild
                            className="fade-up bg-purple-600/30 rounded-none hover:bg-purple-700/50 text-white flex-1 group relative overflow-hidden"
                        >
                    ...
                    }
                    {
                        ...
                        <Button
                            asChild
                            variant="outline"
                            className="fade-up text-gray-300 rounded-none border-gray-700 hover:border-purple-500 hover:text-white flex-1 group relative overflow-hidden"
                        >

...
export const Socials = () => {
    return (
        <div className="w-full flex flex-col items-center justify-center px-4 pt-24 gap-6">
            ...
            <h3 className="fade-up text-center text-lg sm:text-2xl font-medium opacity-90 bg-gradient-to-b font-breeserif from-white to-zinc-300 bg-clip-text text-transparent">Stay updated with my latest projects and insights</h3>
                    ...
                    socials?.map((social: SocialType) => {
                        ...
                        return (
                            <ActionTooltip key={social?.id} side='top' label={social?.label}>
                                <Link href={social?.link} target="_blank" className="fade-up group flex items-center hover:scale-105 transition-all duration-100">
                                    <Icon

...
export const AboutSection = () => {
    return (
        <div className="w-full min-h-screen pt-32 sm:pt-24 pb-8 md:pb-12 px-4 sm:px-8 md:px-16 flex flex-col md:flex-row items-stretch md:items-center justify-start md:justify-between gap-8">
            <div className="w-full md:w-6/12 lg:w-7/12 flex flex-col justify-center items-start text-left gap-4 lg:pr-20">
                <h2 className="fade-up w-full text-left text-2xl sm:text-3xl md:text-4xl font-bold font-breeserif italic pr-12 bg-gradient-to-b from-white to-zinc-300 bg-clip-text text-transparent transition-all duration-300">
                    A Bit About Me
                </h2>
                ...
                <div className="flex justify-start items-center gap-6 md:mt-8">
                    <div className="fade-up flex flex-col items-center  justify-center border- border-white/70- px-8- sm:px-12- py-2 sm:py-3.5 ">
            ...
            <div className="fade-up relative w-full md:w-6/12 lg:w-5/12 h-[300px] min-[400px]:h-[400px] min-[450px]:h-[500px] md:h-[450px] transition-all duration-300 ">
                <Image
                src="/kineshlohar.jpg"

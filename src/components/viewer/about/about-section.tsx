...
export const AboutSection = () => {
    return (
        <div className="w-full min-h-screen pt-30 pb-16 px-4 flex flex-col justify-between items-stretch ">
            ...
            <div className=' text-right text-xs sm:text-sm md:text-base sm:w-8/12 lg:w-6/12 place-self-end sm:pr-16 font-serif'>
                ...
                <div className="flex flex-col sm:flex-row justify-center sm:justify-end items-end sm:items-center gap-1 mt-2">
                    <div className="flex flex-col items-center  justify-center border border-white/70 px-8 sm:px-12 py-2 sm:py-3.5 ">
                        <div className="text-2xl sm:text-3xl font-medium font-serif">
                            2+
                        </div>

...
export const AboutSection = () => {
    return (
        <div className="w-full min-h-screen pt-32 sm:pt-24 pb-20 sm:pb-16 px-4 flex flex-col justify-between items-stretch ">
            <h2 className="fade-up w-full sm:mt-6 text-left text-2xl sm:text-3xl md:text-4xl font-bold font-breeserif italic pr-12 sm:pr-0 sm:pl-8 md:pl-16 bg-gradient-to-b from-white to-zinc-300 bg-clip-text text-transparent transition-all duration-300">
                A Bit About Me
            </h2>

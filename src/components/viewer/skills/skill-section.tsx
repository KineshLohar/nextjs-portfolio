...
export const SkillsSection = async () => {
    ...
    return (
        <div className="w-full min-h-screen py-16 md:py-24 bg-black">
            <div className="relative max-w-7xl mx-auto px-4 sm:pl-8 md:px-8 lg:px-8 mb-12">
                <h2 className="fade-up text-2xl italic md:text-4xl mb-4 font-breeserif text-white max-w-4xl">
                    <span className="text-3xl md:text-4xl tracking-wide italic font-breeserif">
                        Tech Stack Arsenal
                    </span>
                </h2>

                <span className="fade-up absolute bottom-[-12px] w-32 md:w-72 h-[2px] bg-gradient-to-r from-transparent via-zinc-600 to-transparent animate-line-expand" />
            </div>

            <div className="w-full px-4 md:px-8 max-w-7xl mx-auto grid gap-8">
                {data.map((item) => (
                    <div key={item.type} className="rounded-xl md:rounded-2xl">
                        <div className="space-y-4">
                            <div className="fade-up flex items-center gap-3">
                                <div className="h-[2px] w-6 md:w-8 bg-gradient-to-r from-rose-700 to-transparent" />

                                <h3 className="font-medium md:font-semibold text-base md:text-xl text-zinc-300">
                                    {item.type}
                                </h3>
                            </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3">
                                {item.skills.map((skill) => (
                                    <div
                                        ...
                                        className="fade-up group relative min-h-[100px] md:min-h-[120px] md:p-4 rounded-lg border border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900 transition-colors duration-200"
                                    >
                                        ...
                                        {(skill.projects ||
                                            ...
                                            skill.description) && (
                                                <div className="absolute z-50 hidden group-hover:block bottom-full mb-2 left-0 right-0">
                                                    <div className="p-4 md:p-5 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl">
